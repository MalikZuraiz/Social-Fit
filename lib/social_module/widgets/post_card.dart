...
import 'package:social_fit/social_module/widgets/error_image_widget.dart';
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              // Place the if statement inside curly braces {}
              trailing: widget.userEmail == currentUser.email
                  ...
                  : null, // Set trailing to null when the condition is false
            ),
            SizedBox(
      ...
      children: [
        ...
        Expanded(
          child: _CommentButton(
              postID: widget.postID, commentImage: widget.imageofUser!),
        ),
        // Expanded(
        //   child: _ToggleButton(
