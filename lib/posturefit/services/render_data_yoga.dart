// ignore_for_file: library_private_types_in_public_api, unnecessary_new, prefer_collection_literals, no_leading_underscores_for_local_identifiers, avoid_function_literals_in_foreach_calls, prefer_typing_uninitialized_variables, avoid_single_cascade_in_expression_statements, prefer_const_constructors, unnecessary_string_interpolations, avoid_renaming_method_parameters
...
class RenderDataYoga extends StatefulWidget {
  ...
  const RenderDataYoga(
      {super.key, required this.data, required this.previewH, required this.previewW, required this.screenH, required this.screenW});
  @override
...
class _RenderDataYogaState extends State<RenderDataYoga> {
  ...
  late bool wristAlignment, shoulderAlignment, ankleAlignment, kneeAndHipAlignment;
